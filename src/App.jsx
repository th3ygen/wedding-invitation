    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-[#fdfcf9] to-[#f0e9e0]">
      <div className={`envelope-container ${opened ? 'opened' : ''}`}>
        ...
        <audio ref={audioRef} id="bg-music" loop preload="auto">
          <source src="sound/howls-moving-castle.mp3" type="audio/mpeg" />
        </audio>
        ...
        <div className="card">
          ...
          <section ref={coverRef} className="relative flex items-center justify-center min-h-screen bg-[#fcf0f0] overflow-hidden">
            <img src="assets/frame.png" alt="Frame" className="w-[90%] h-auto md:w-[80%] lg:w-[70%] mx-auto -mt-[15%] md:-mt-[20%]" />
            <img src="assets/flower.png" alt="" className="absolute top-0 left-0 w-24 md:w-32" />
            <img src="assets/blue-flower.png" alt="" className="absolute top-1/2 left-0 w-20 md:w-28 -translate-y-1/2" />
            <img src="assets/white-flower.png" alt="" className="absolute bottom-0 right-0 w-24 md:w-32 pb-[60px]" />
            <img src="assets/pink-flower.png" alt="" className="absolute top-1/2 right-0 w-20 md:w-28 -translate-y-1/2" />
            <img src="assets/top-right.png" alt="" className="absolute top-0 right-0 w-40 md:w-48" />
            <img src="assets/bot-left.png" alt="" className="absolute bottom-0 left-0 w-40 md:w-48 pb-[60px]" />
          ...
          <section ref={programRef} className="flex flex-col items-center justify-center py-16 bg-cover bg-center gap-8">
            <div className="relative w-[75%] max-w-xs mx-auto">
              <img src="assets/thing.png" alt="Programme" className="w-full h-auto mb-5" />
