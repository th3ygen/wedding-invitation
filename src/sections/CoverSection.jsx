...
export const CoverSection = forwardRef((_, ref) => (
  <section ref={ref} className="relative flex items-center justify-center bg-[#fcf0f0] overflow-hidden" style={{ minHeight: '100dvh' }}>
    ...
    <img src={topRight} alt="" className="px-slow absolute top-0 right-0 w-40 md:w-48" />
    <img src={botLeft} alt="" className="px-slow absolute bottom-0 left-0 w-40 md:w-48 pb-[60px]" />

    {/* Accent flowers — mid drift */}
    <img src={flower}     alt="" className="px-mid absolute top-0 left-0 w-24 md:w-32" />
    <img src={whiteFlower} alt="" className="px-mid absolute bottom-0 right-0 w-24 md:w-32 pb-[60px]" />

    {/* Side flowers — fast drift, feel closest */}
    <img src={blueFlower} alt="" className="px-fast absolute top-1/2 left-0 w-20 md:w-28 -translate-y-1/2" />
    <img src={pinkFlower} alt="" className="px-fast absolute top-1/2 right-0 w-20 md:w-28 -translate-y-1/2" />
